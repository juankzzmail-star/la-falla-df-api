-- Seed de proyectos de demostración — La Falla D.F. · Centro de Mando v1.4
-- Ejecutar DESPUÉS de que las tablas projects/deliverables existan (ddl_v*.sql aplicados).
-- Idempotente: ON CONFLICT DO NOTHING — seguro ejecutar múltiples veces.
